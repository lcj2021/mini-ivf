...
# include "RCF/external/asio/asio/detail/null_tss_ptr.hpp"
#elif defined(ASIO_HAS_THREAD_KEYWORD_EXTENSION)
# include "RCF/external/asio/asio/detail/keyword_tss_ptr.hpp"
#elif defined(ASIO_WINDOWS)
# include "RCF/external/asio/asio/detail/win_tss_ptr.hpp"
#elif defined(ASIO_HAS_PTHREADS)
# include "RCF/external/asio/asio/detail/posix_tss_ptr.hpp"
#else
