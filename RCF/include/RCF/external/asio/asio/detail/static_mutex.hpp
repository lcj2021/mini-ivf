...
# include "RCF/external/asio/asio/detail/null_static_mutex.hpp"
#elif defined(ASIO_WINDOWS)
# include "RCF/external/asio/asio/detail/win_static_mutex.hpp"
#elif defined(ASIO_HAS_PTHREADS)
# include "RCF/external/asio/asio/detail/posix_static_mutex.hpp"
#elif defined(ASIO_HAS_STD_MUTEX_AND_CONDVAR)
# include "RCF/external/asio/asio/detail/std_static_mutex.hpp"
#else
