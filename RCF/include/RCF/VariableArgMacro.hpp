...
namespace RCF {
    ...
    RCF_EXPORT void printToOstream(MemOstream & os, std::uint16_t n);
    RCF_EXPORT void printToOstream(MemOstream & os, std::uint32_t n);
    RCF_EXPORT void printToOstream(MemOstream & os, std::uint64_t n);
...
namespace RCF {
    ...
    class RCF_EXPORT VariableArgMacroFunctor
    {
    public:
